...
north_members = north_members_with_centers[
    north_members_with_centers.galaxy_z != north_members_with_centers.cluster_z
].copy()
...
np.save("reweighting_north_nan_fill", smoothed_reweightings)
