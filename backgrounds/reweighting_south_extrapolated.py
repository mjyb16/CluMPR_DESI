...
south_members = south_members_with_centers[south_members_with_centers.galaxy_z != south_members_with_centers.cluster_z].copy()
...
np.save("reweighting_south_extrapolated", smoothed_reweightings)
